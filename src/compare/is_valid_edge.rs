...
pub fn is_valid_edge_i16i((x1, y1, _): (i16, i16, i16), (x2, y2, _): (i16, i16, i16)) -> bool {
    let total =
        (x1 as i32 & 0xFFFF) + (y1 as i32 & 0xFFFF) + (x2 as i32 & 0xFFFF) + (y2 as i32 & 0xFFFF);
    (4 <= total) && (total <= 10)
}

pub fn is_valid_edge21((x1, y1, _): (i32, i32, i32), (x2, y2, _): (i32, i32, i32)) -> bool {
    ((x1 & 0xFFFF + y1 & 0xFFFF + x2 & 0xFFFF + y2 & 0xFFFF) >= 4)
        && ((x1 & 0xFFFF + y1 & 0xFFFF + x2 & 0xFFFF + y2 & 0xFFFF) <= 10)
}
